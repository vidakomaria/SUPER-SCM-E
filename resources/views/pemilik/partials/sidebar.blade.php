<div class="sidebar shadow">
    ...
    <ul class="nav flex-column align-items-stretch mb-auto ml-4">
        <div class="d-flex flex-column pt-4">
            ...
            <li class="nav-item my-2">
                <a href="#" class="nav-link text-white {{ Request::is('pemilik/pesanan*') ? 'active' : '' }}" aria-current="page">
                    <i class="bi bi-journal-text me-3"></i>Pesanan</a>
            </li>
            <li class="nav-item my-2">
                <a href="#" class="nav-link text-white {{ Request::is('pemilik/keranjang*') ? 'active' : '' }}" aria-current="page">
                    <i class="fa fa-shopping-cart me-3"></i>Keranjang</a>
            </li>
        </div>
