...
@section('container')
    <div class="m-0">
        ...
        <div class="container-fluid mt-3 pt-2 mx-0 px-0">
            <!--Add Produk-->
                    ...
                    <div class="col-10">
                        <table class="table table-borderless w-75">
                                ...
                                <td>
                                    <select class="form-select my-3 @error('id_kategori') is-invalid @enderror" name="id_kategori">
                                        ...
                                        @foreach($categories as $kategori)
                                            @if($kategori->id == old('id_kategori',$produk->id_kategori))
                            ...
                            <tr>
                                ...
                                <td class=" pb-2 d-grid gap-2 d-md-flex justify-content-end">
